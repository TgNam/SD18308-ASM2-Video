...
<div class="container">
    <div class="mb-3">
        <c:url var="url" value="/khachHang"></c:url>
        <form action="${url}/home" method="post">
            ...
            <div class="mb-3">
                <label>Họ tên</label>
                <input type="text" value="${form.hoTen}" name="hoTen" class="form-control">
            </div>
            <div class="mb-3">
                <label>Địa chỉ</label>
                <input type="text" value="${form.diaChi}" name="diaChi" class="form-control">
            </div>
            <div class="mb-3">
                <label>SDT</label>
                <input type="text" value="${form.sdt}" name="sdt" class="form-control">
            </div>
            <div class="mb-3">
