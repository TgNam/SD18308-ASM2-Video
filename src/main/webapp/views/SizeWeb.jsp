...
<div class="container">
    <div class="mb-3">
        <c:url var="url" value="/size"></c:url>
        <form action="${url}/home" method="post">
            ...
            <div class="mb-3">
                <label>Mã size</label>
                <input type="text" value="${form.maSize}" name="maSize" class="form-control">
            </div>
            <div class="mb-3">
                <label>Tên size</label>
                <input type="text" value="${form.tenSize}" name="tenSize" class="form-control">
            </div>
            <div class="mb-3">
    ...
    <div class="mb-3">
        <table class="table">
            ...
            <c:forEach var="item" items="${Item}">
                <tr>
                    <td>${item.getId()}</td>
                    <td>${item.getMaSize()}</td>
                    <td>${item.getTenSize()}</td>
